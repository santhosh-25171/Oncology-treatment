...
to beginners (it literally asks yes/no questions, like a human would) and
matches the study material's "classification fundamentals, decision trees"
requirement.
"""
...
print("Feature importance (which signal matters most for risk):")

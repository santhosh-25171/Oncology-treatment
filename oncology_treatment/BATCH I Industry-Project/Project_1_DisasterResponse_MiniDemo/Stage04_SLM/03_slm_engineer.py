...
Turn a dense multi-sentence report into 2 crisp, actionable sentences.
...
how many "important" words it has, then keep the TOP 2 sentences. Same
INPUT -> OUTPUT shape as a real fine-tuned SLM, runs instantly offline.
"""

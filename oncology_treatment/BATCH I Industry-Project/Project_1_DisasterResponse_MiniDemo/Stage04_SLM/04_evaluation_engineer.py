...
JOB: "Benchmark perplexity, summary fidelity, and inference latency under
stress."

WHY THIS STEP EXISTS:
The problem statement's own Team Huddle says: if reading the summary
doesn't save at least 80% of the reading time versus the full report,
the summary needs to be refined. We check that here.
"""

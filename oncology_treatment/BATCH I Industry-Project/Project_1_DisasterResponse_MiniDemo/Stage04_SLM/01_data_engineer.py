...
JOB: "Curate and format report-summary pairs into a clean fine-tuning
dataset."

WHY THIS STEP EXISTS:
A summarizer needs to be shown examples of (long report -> what a human
would say instead). This role prepares that training data cleanly.
"""
...
print(f"Prepared {len(df)} reports for summarization.")
